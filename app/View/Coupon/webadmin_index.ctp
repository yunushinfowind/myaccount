    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-sm-12">
			    ...
			    <div class="adminCoupn">
				<table  class="display table table-bordered table-striped" id="<?php if (!empty($coupons)) {
				echo 'dynamic-table';
			    } ?>">
				    <thead>
					<tr>
					...
					if (!empty($coupons)) {
					    ...
					    echo '<tr class="gradeX"><td colspan="10" style="text-align:center;">No Coupons available!</td></tr>';
					}
					?>
				    </tbody>
				    <tfoot>
