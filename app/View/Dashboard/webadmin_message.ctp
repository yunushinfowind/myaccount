                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="form">
                            ...
                            <?php echo $this->Form->create('Email_content', array('url' => array('controller' => 'dashboard', 'action' => 'message', 'prefix' => 'webadmin'), 'id' => 'AddPageForm', 'class' => 'cmxform form-horizontal', 'enctype' => 'multipart/form-data')); ?>   
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                        <textarea rows="1000" id="editor1" class="form-control ckeditor" name="data[Email_content][message]"><?php echo @$data['Email_content']['content'];?></textarea> 
