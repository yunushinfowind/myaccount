...
<html>
    <head>
        ...
        <title><?php echo $data['Email_content']['subject']; ?></title>
    </head>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <p style="padding:10px 25px 10px 25px; font-size:14px; margin:0px; background: #F4F4F4; border-bottom: 1px solid #d4d4d4;">
                                                <strong><?php echo $data['Email_content']['subject']; ?></strong>
                                            </p>


                                            <h3 style="border-bottom: 1px solid #f4f4f4; color:#555; font-weight: lighter; padding-left: 25px ; padding-bottom: 16px;">

                                                <?php
                                                $search = array('{name}', '{link}');
                                                $replace = array($getUser['User']['first_name'] . ' ' . $getUser['User']['last_name'], 'http://lesson.picnframes.info/developer/frontend/password/' . $token);
