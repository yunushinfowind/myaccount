                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <p style="padding:0px 25px 10px 25px; font-size:15px; margin:0px; text-align: justify; color:#555; ">
                                                The student named <?php echo ucfirst($student_details['User']['first_name']) . ' ' . ucfirst($student_details['User']['last_name']); ?> has made some changes in the profile whose Email is <?php echo $student_details['User']['email']; ?><br/><br/>
