...
<html>
    <head>
        ...
        <title><?php echo ucfirst($email_data['Email_content']['subject']); ?></title>
    </head>
    <body marginheight="0" topmargin="0" marginwidth="0" leftmargin="0">
        <table style="margin: 0 auto ;" class="cust_table" width="640" cellspaciFng="0" cellpadding="0" >
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <p style="padding:10px 25px 10px 25px; font-size:14px; margin:0px; background: #F4F4F4; border-bottom: 1px solid #d4d4d4;">
                                                <strong><?php echo ucfirst($email_data['Email_content']['subject']); ?></strong>
                                            </p>

                                            <?php
                                            $search = array('{name}', '{number}', '{amount}', '{date}');
                                            $replace = array(ucfirst($user['User']['first_name']) . ' ' . ucfirst($user['User']['last_name']), $account_number, $amt_to_be_deducted, date('m/d/Y'));
