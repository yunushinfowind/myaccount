<?php echo ucfirst($data['Email_content']['subject']); ?>

Dear <?php echo ucfirst($find_user['User']['first_name']) . ' ' . ucfirst($find_user['User']['last_name']); ?>,
...
Please note that you can change your temporary password from within your account at any time.
    ...
    Email : <?php echo $find_user['User']['email']; ?>
    Temporary Password : <?php echo $new_password; ?>
