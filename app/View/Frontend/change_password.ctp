...
<div class="banner">
	...
	<div class="login">
	    ...
	    <div class="login_form change_pass clearfix">
		<div class="col-md-8 col-md-offset-2 chngepwd">
		    <?php echo $this->Session->Flash(); ?>
		    <?php echo $this->Form->create('User', array('url' => array('controller' => 'frontend', 'action' => 'change_password'), 'class' => 'form-horizontal')); ?>
		    <div class="form-group">
			<label for="inputEmail3" class="col-sm-5 control-label">Old Password</label>
			<div class="col-sm-7">
			    <?php echo $this->Form->input('old_password', array('label' => FALSE, 'type' => 'password', 'class' => 'form-control')); ?>
			</div>
		    </div>
		    <div class="form-group">
			...
			<div class="col-sm-7">
			    <?php echo $this->Form->input('confirm_password', array('label' => FALSE, 'type' => 'password', 'class' => 'form-control')); ?>
			</div>
		    </div>
		    <div class="row">
