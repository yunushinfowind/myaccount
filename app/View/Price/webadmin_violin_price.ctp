            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <?php echo $this->Form->create('Price', array('url' => array('controller' => 'price', 'action' => 'violin_price', 'prefix' => 'webadmin'), 'id' => 'AddPageForm', 'class' => 'cmxform form-horizontal', 'enctype' => 'multipart/form-data')); ?>   
                                ...
                                if (!empty($violinRate)) {
                                    ...
                                    foreach ($violinRate as $rate) {
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td style="text-align: center;"><a href="<?php echo BASE_URL . 'webadmin/price/delete_violin_rate/' . $rate['Price']['id']; ?>" onclick="return confirm('Are you sure?');"><i class="fa fa-trash-o"></i></a></td>
                                        </tr>
                                        <?php
                                        $i++;
                                    }
