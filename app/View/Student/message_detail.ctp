<div class="new_ryt padding-right">
    <div class="right_side clearfix">
		...
		foreach ($messag_thread as $msg) {
			...
			?>">
				...
				if (!empty($msg['Message']['file'])) {
				    ...
				    <?php } elseif ($extension == 'jpeg' || $extension == 'jpg' || $extension == 'png') { ?>
	    ...
	    <?php echo $this->Form->create('Message', array('url' => array('controller' => 'student', 'action' => 'message_detail', $this->params['pass'][0]), 'class' => 'profile_form', 'enctype' => 'multipart/form-data')); ?>  
	    <?php echo $this->Form->input('message', array('label' => FALSE, 'class' => 'messageText form-control', 'type' => 'textarea', 'rows' => 3, 'id' => 'message')); ?>
            <!--<textarea rows="3" class='messageText form-control' name='data[msg]'></textarea>-->
            <div class="btns">
...
<!--<input type="file" class="upload" name="data['msg]">-->
                    </div>
                </div>
