            ...
            if (!empty($students)) {
                if ($get_data['Calendar']['completed_type'] == 'markcompleted') {
                    foreach ($students as $student) {
                        if (isset($student['User']) && !empty($student['User'])) {
                            ?>

                            <option value = "<?php
                            echo $student['User']['id'];
                            ?>" <?php
                                    if ($get_data['Calendar']['user_id'] == $student['User']['id']) {
                                        echo 'selected';
                                    } else {
                                        echo 'disabled="disabled"';
                                    }
                                    ?>><?php echo ucfirst($student['User']['first_name']) . ' ' . ucfirst($student['User']['last_name']); ?>
                            </option>
                            <?php
                        }
                    }
    ...
    <div class="col-lg-9">
        <div class="form-group">
            <div id="timepicker1" class="input-group date">
                ...
                <span class="input-group-addon" id="Edit_start">
...
<div class="col-lg-12 form-group">
    ...
    <div class="col-lg-9">
        <div class="form-group">
            ...
            </div></div></div></div></div><div class="col-lg-12 form-group"><div class="col-lg-3"></div><div class="col-lg-9"><div class="radio"><label><input type="radio" value="markcompleted" name="completed_type" class="radioComplete"
                <?php
                if ($get_data['Calendar']['completed_type'] == 'markcompleted') {
                    $isMarkedComplete = true;
...
?>>
    ...
    <div class="col-lg-9">
        <div class="textarea">
            <textarea id="remarks" class="form-control" placeholder="Remarks"><?php echo $get_data['Calendar']['completed_remarks']; ?>
            </textarea>
        </div>
    </div>
</div>
...
<input type="hidden" id="getSubjectName" value="<?php echo $subject['Subject']['subject']; ?>">
</div>
