...
abstract class AuthorizeNetRequest
{
  ...
  $post_url = "https://secure.bngpaymentgateway.com/gateway/transact.dll";  //added by anchal  on 13 august,2015 used only for AIM method
  //$post_url = "https://secure.networkmerchants.com/api/transact.php";  //added by anchal  on 13 august,2015 used only for AIM method
