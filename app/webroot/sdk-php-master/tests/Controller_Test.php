...
require_once INCLUDE_PATH . 'sdk-php-master/autoload.php';
//include if tests/bootstrap.php is not loaded automatically
//require_once __DIR__ . '/bootstrap.php';
require_once INCLUDE_PATH . 'sdk-php-master/tests/bootstrap.php';
...
class Controller_Test extends PHPUnit_Framework_TestCase {
    ...
    public function testARBGetSubscriptionList() {
        ...
        $name = (defined('AUTHORIZENET_API_LOGIN_ID') && '' != AUTHORIZENET_API_LOGIN_ID) ? AUTHORIZENET_API_LOGIN_ID : getenv("99AJ26pH3rK");
        $transactionKey = (defined('AUTHORIZENET_TRANSACTION_KEY') && '' != AUTHORIZENET_TRANSACTION_KEY) ? AUTHORIZENET_TRANSACTION_KEY : getenv("3ry5HNn77UbYZ32V");
